...
def load_single_features(seed: int, disease: str, feature: List):
    ...
    """
    print(feature)
    path = f"/root/XXXMicro/Data/{disease}/{feature[0]}_abundance.csv"
...
def load_full_features(seed: int, disease: str, feature: List, sort: bool=False, noise: float = 0):
    ...
    print(feature)
    if noise:
        f1_path = f"/root/XXXMicro/Data/{disease}/{feature[0]}_noisy_{noise}_abundance.csv"
        f2_path = f"/root/XXXMicro/Data/{disease}/{feature[1]}_noisy_{noise}_abundance.csv"
    else:
        f1_path = f"/root/XXXMicro/Data/{disease}/{feature[0]}_abundance.csv"
        f2_path = f"/root/XXXMicro/Data/{disease}/{feature[1]}_abundance.csv"
...
def load_features(disease: str, features: List):
    fps = [
        f"/root/XXXMicro/Data/{disease}/{features[0]}_abundance.csv",
        f"/root/XXXMicro/Data/{disease}/{features[1]}_abundance.csv"
    ]  # 根据特征名字提取路径
